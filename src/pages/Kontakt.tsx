      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold mb-6" style={{ color: '#1E5F8E' }}>Dane firmy</h2>
            ...
            <div className="rounded-xl p-5 border flex items-start gap-4" style={{ borderColor: '#e5f3ff', background: '#f8fbff' }}>
              ...
              <div>
                <p className="font-bold text-sm mb-1" style={{ color: '#1E5F8E' }}>Shoppalyzer Sp. z o.o.</p>
            ...
            <div className="rounded-xl p-5 border flex items-start gap-4" style={{ borderColor: '#e5f3ff', background: '#f8fbff' }}>
              <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
                <Phone className="h-5 w-5" style={{ color: '#1E5F8E' }} />
              </div>
              <div>
                <p className="font-bold text-sm mb-1" style={{ color: '#1E5F8E' }}>Telefon</p>
                <a href="tel:123456789" className="text-sm font-semibold hover:underline" style={{ color: '#F0921C' }}>123 456 789</a>
              </div>
            </div>
            ...
            <div className="rounded-xl p-5 border flex items-start gap-4" style={{ borderColor: '#e5f3ff', background: '#f8fbff' }}>
              <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
                <Mail className="h-5 w-5" style={{ color: '#1E5F8E' }} />
              </div>
              <div>
                <p className="font-bold text-sm mb-1" style={{ color: '#1E5F8E' }}>E-mail</p>
                <a href="mailto:shoppalyzer@gmail.com" className="text-sm font-semibold hover:underline" style={{ color: '#F0921C' }}>shoppalyzer@gmail.com</a>
              </div>
            </div>
            ...
            <div className="rounded-xl p-5 border flex items-start gap-4" style={{ borderColor: '#e5f3ff', background: '#f8fbff' }}>
              ...
              <div>
                <p className="font-bold text-sm mb-2" style={{ color: '#1E5F8E' }}>Godziny pracy</p>
          ...
          {/* Formularz */}
          <div>
            <h2 className="text-2xl font-bold mb-6" style={{ color: '#1E5F8E' }}>Napisz do nas</h2>
            {sent ? (
              <div className="rounded-xl p-8 text-center" style={{ background: '#f8fbff', border: '2px solid #e5f3ff' }}>
                <div className="text-5xl mb-4">✅</div>
                <h3 className="font-bold text-lg mb-2" style={{ color: '#1E5F8E' }}>Dziękujemy za wiadomość!</h3>
                ...
                <button
                  ...
                  style={{ color: '#F0921C', background: 'none', border: 'none', cursor: 'pointer' }}
                >
              ...
              <div className="rounded-xl p-6 border space-y-5" style={{ borderColor: '#e5f3ff', background: '#f8fbff' }}>
                ...
                <div>
                  <label className="block text-xs font-semibold mb-1.5" style={{ color: '#1E5F8E' }}>Imię i nazwisko *</label>
                  <input
                    type="text"
                    value={name}
                ...
                <div>
                  <label className="block text-xs font-semibold mb-1.5" style={{ color: '#1E5F8E' }}>Adres e-mail *</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div>
                  <label className="block text-xs font-semibold mb-1.5" style={{ color: '#1E5F8E' }}>Wiadomość *</label>
                  <textarea
                    value={message}
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: 'none',
                    background: (!name || !email || !message) ? '#d1d5db' : '#F0921C',
                    color: 'white',
                    fontWeight: 700,
                    fontSize: '14px',
