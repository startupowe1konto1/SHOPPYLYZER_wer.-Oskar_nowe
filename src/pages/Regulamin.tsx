    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
              <Tag className="h-5 w-5" style={{ color: '#1E5F8E' }} />
            </div>
            <h2 className="text-xl font-bold" style={{ color: '#1E5F8E' }}>§ 2. Definicje</h2>
          </div>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
              <CreditCard className="h-5 w-5" style={{ color: '#1E5F8E' }} />
            </div>
            <h2 className="text-xl font-bold" style={{ color: '#1E5F8E' }}>§ 6. Płatności i Subskrypcje</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4 ml-1 mb-4">
            {[
              ...
              <div key={p.plan} className="rounded-xl p-5 border-2 flex items-center gap-4" style={{ borderColor: '#1E5F8E', background: '#f8fbff' }}>
                <div className="text-3xl">{p.icon}</div>
                <div>
                  <p className="font-bold text-lg" style={{ color: '#1E5F8E' }}>Plan {p.plan}</p>
                  <p className="text-2xl font-extrabold" style={{ color: '#F0921C' }}>{p.price}</p>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
              <AlertTriangle className="h-5 w-5" style={{ color: '#1E5F8E' }} />
            </div>
            <h2 className="text-xl font-bold" style={{ color: '#1E5F8E' }}>§ 9. Zastrzeżenia technologiczne i wyłączenie odpowiedzialności</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4 ml-1">
            {[
              ...
              <div key={c.title} className="rounded-xl p-5 border" style={{ borderColor: '#e5f3ff', background: '#f8fbff' }}>
                <div className="text-2xl mb-2">{c.icon}</div>
                <h3 className="font-bold text-sm mb-2" style={{ color: '#1E5F8E' }}>{c.title}</h3>
                <p className="text-xs text-muted-foreground leading-relaxed">{c.desc}</p>
              </div>
            ))}
          </div>
