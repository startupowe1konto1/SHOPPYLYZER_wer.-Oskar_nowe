...
const Section = ({ icon, number, title, children }: { icon: React.ReactNode; number: string; title: string; children: React.ReactNode }) => (
  <section className="mb-10">
    ...
    <div className="pl-13 ml-1 border-l-2 pl-6" style={{ borderColor: '#F0921C' }}>
      {children}
    </div>
  </section>
);
...
<button
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
              <Database className="h-5 w-5" style={{ color: '#1E5F8E' }} />
            </div>
            <h2 className="text-xl font-bold" style={{ color: '#1E5F8E' }}>3. Zakres przetwarzanych danych</h2>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i.title} className="flex gap-3 rounded-xl p-4" style={{ background: '#f8fbff', border: '1px solid #e5f3ff' }}>
                <span className="text-xs font-bold px-2 py-1 rounded-lg shrink-0 h-fit" style={{ background: '#F0921C', color: 'white' }}>{i.base}</span>
                <div>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {[
              ...
              <div key={r} className="flex items-center gap-2 text-sm text-muted-foreground">
                <div className="w-2 h-2 rounded-full shrink-0" style={{ background: '#F0921C' }}></div>
                {r}
              </div>
            ))}
          </div>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0" style={{ background: '#e5f3ff' }}>
              <CheckCircle className="h-5 w-5" style={{ color: '#1E5F8E' }} />
            </div>
            <h2 className="text-xl font-bold" style={{ color: '#1E5F8E' }}>8. Prawa Użytkownika</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-3 ml-1">
            {[
              ...
              <div key={r} className="flex items-start gap-2 rounded-lg p-3" style={{ background: '#f8fbff', border: '1px solid #e5f3ff' }}>
                <CheckCircle className="h-4 w-4 shrink-0 mt-0.5" style={{ color: '#F0921C' }} />
                <span className="text-sm text-muted-foreground">{r}</span>
              </div>
            ))}
          </div>
          <div className="mt-4 ml-1 flex items-center gap-3 rounded-xl p-4" style={{ background: '#1E5F8E' }}>
